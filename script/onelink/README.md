...
Проверки выбираются по diff: Ruby, Vue, migration и Docker-проверки запускаются только
когда соответствующий слой изменился. Автоматический flow принимает только безопасные
