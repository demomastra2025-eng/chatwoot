...
<template>
  <TeleportWithDirection to="body">
    <div class="fixed inset-0 z-[1200] flex items-center justify-center p-4">
      ...
      />
      <div
        class="relative z-[1201] grid w-[44rem] max-w-[calc(100vw-3rem)] grid-cols-[minmax(14rem,18rem)_minmax(0,1fr)] overflow-hidden rounded-xl border border-n-weak bg-n-solid-1 shadow-lg"
        @click.stop
      >
          ...
          >
            ...
            <template v-else>
              ...
              <textarea
                ...
                :placeholder="
                  t('CAPTAIN.ASSISTANTS.SKILLS.CONTENT_PLACEHOLDER')
                "
              />
            </template>
