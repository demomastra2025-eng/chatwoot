  ...
  it.each(Object.entries(locales))(
    ...
    (_, messages) => {
      [
        ...
        'INBOX_MGMT.ADD.WEIXIN_CHANNEL.ILINK_TOKEN.PLACEHOLDER',
        'INBOX_MGMT.ADD.WEIXIN_CHANNEL.ILINK_TOKEN.SUBTITLE',
        'INBOX_MGMT.ADD.WEIXIN_CHANNEL.PROVIDER_ACCOUNT_ID.LABEL',
        'INBOX_MGMT.ADD.WEIXIN_CHANNEL.PROVIDER_ACCOUNT_ID.PLACEHOLDER',
        'INBOX_MGMT.ADD.WEIXIN_CHANNEL.PROVIDER_ACCOUNT_ID.SUBTITLE',
