...
export const formatCrmErrorMessage = (error, t) => {
  ...
  switch (payload.code) {
    ...
    case 'DEAL_STAGE_INVALID_TRANSITION_REASON':
      return t('CRM.ERRORS.DEAL_STAGE_INVALID_TRANSITION_REASON');
    case 'DEAL_STAGE_REQUIRES_CLOSING_REASONS':
      return t('CRM.ERRORS.DEAL_STAGE_REQUIRES_CLOSING_REASONS');
    case 'DEAL_STAGE_REQUIRES_TRANSITION_REASON':
      return t('CRM.ERRORS.DEAL_STAGE_REQUIRES_TRANSITION_REASON');
