module ActivityMessageHandler
  ...
  def activity_message_params(content)
    ...
    event_id = last_saved_communication_thread_event_id || communication_thread_event_id
    return params if event_id.blank?

    params[:additional_attributes] = { communication_thread_event_id: event_id }
    params
  end
