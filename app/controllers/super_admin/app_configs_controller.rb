class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  CAPTAIN_CONFIG_KEYS = %w[
    ...
    CAPTAIN_AUDIO_TRANSCRIPTION_MODEL CAPTAIN_IMAGE_RECOGNITION_MODEL CAPTAIN_EMBEDDING_MODEL
    CAPTAIN_ASSISTANT_MODEL_ALLOWLIST CAPTAIN_AI_AGENT_SYSTEM_PROMPT CAPTAIN_SYSTEM_PROMPTS
