class Api::V1::Accounts::UploadController < Api::V1::Accounts::BaseController
  ...
  def create_from_url
    ...
    render_error(I18n.t('errors.upload.fetch_failed_with_message', message: e.message), :unprocessable_content)
  rescue SafeFetch::InvalidUrlError, SafeFetch::UnsafeUrlError
    render_error(I18n.t('errors.upload.invalid_url'), :unprocessable_content)
  rescue SafeFetch::FetchError
    render_error(I18n.t('errors.upload.fetch_failed'), :unprocessable_content)
  rescue SafeFetch::FileTooLargeError
    render_error(I18n.t('errors.upload.file_too_large'), :unprocessable_content)
  rescue SafeFetch::UnsupportedContentTypeError
    render_error(I18n.t('errors.upload.unsupported_content_type'), :unprocessable_content)
