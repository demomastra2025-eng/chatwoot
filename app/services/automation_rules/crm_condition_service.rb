class AutomationRules::CrmConditionService
  ...
  attr_reader :rule, :record, :entity_kind, :changed_attributes
  ...
  def evaluate_custom_condition(definition, operator, condition)
    ...
    evaluate_typed_condition(definition.field_type, raw_value, condition, operator)
  end
  ...
  def evaluate_standard_condition(key, operator, condition)
    ...
    evaluate_typed_condition(field_catalog.field_type_for(key), raw_value, condition, operator)
  end

  def evaluate_typed_condition(field_type, raw_value, condition, operator)
    case field_type
    when *AutomationRules::CrmFieldCatalog::DISCRETE_FIELD_TYPES
      evaluate_discrete_condition(field_type, raw_value, condition, operator)
    when *AutomationRules::CrmFieldCatalog::TEXT_FIELD_TYPES
      evaluate_text_condition(raw_value, condition, operator)
    when *AutomationRules::CrmFieldCatalog::NUMERIC_FIELD_TYPES
  ...
  def field_catalog
    @field_catalog ||= AutomationRules::CrmFieldCatalog.new(
