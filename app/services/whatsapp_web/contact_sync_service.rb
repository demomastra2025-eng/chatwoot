class WhatsappWeb::ContactSyncService
  ...
  def merge_contact_records!(source_contact:, target_contact:)
    ...
    Contacts::PhoneIdentityLock.acquire!(account_id: channel.inbox.account_id)
    # Match conversation identity resolution and contact merges: Contact before ContactInbox.
    # Reload also discards attributes from the failed phone/identifier validation.
    ...
    # Release unique identities before transferring them; rollback restores both on failure.
