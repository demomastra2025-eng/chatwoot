...
function loadConfig(env = process.env) {
  return {
    ...
    janusServerProviderWsUrls: {
      ...
      beeline: env.VOICE_AGENT_JANUS_SERVER_BEELINE_WS_URL || env.ONELINK_AI_VOICE_JANUS_SERVER_BEELINE_WS_URL || '',
      wazo: env.VOICE_AGENT_JANUS_SERVER_WAZO_WS_URL || env.ONELINK_AI_VOICE_JANUS_SERVER_WAZO_WS_URL || ''
    },
