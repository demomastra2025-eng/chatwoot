...
const STATE_DIR = process.env.KASPI_PAY_ADAPTER_STATE_DIR || path.join(ROOT_DIR, '.state');
...
// Device public parameters are intentionally not logged in production.
...
// Kaspi validates the mobile client fingerprint. Defaults track the verified
// upstream profile; environment overrides allow an emergency update without a code rebuild.
...
export const APP = {
  ...
  cfNetwork: process.env.APP_CF_NETWORK || 'CFNetwork/3826.500.131',
