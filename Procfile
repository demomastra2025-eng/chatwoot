...
reminders_worker: ENABLE_SIDEKIQ_CRON=false DISABLE_SIDEKIQ_ALIVE=true bundle exec rails ip_lookup:setup && bundle exec sidekiq -C config/sidekiq_reminders.yml
