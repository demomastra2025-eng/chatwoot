...
echo "Onelink installation is complete"
echo "The server will be accessible at http://<server-ip>:3000"
echo "To configure a domain and SSL certificate, follow the guide at https://one-link.kz/docs/deployment/deploy-chatwoot-in-linux-vm"
