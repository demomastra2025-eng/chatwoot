...
RSpec.describe AdministratorNotifications::ChannelNotificationsMailer do
  ...
  describe 'facebook_disconnect' do
    ...
    context 'when sending the actual email' do
      ...
      it 'renders the subject' do
        expect(mail.subject).to eq('Your Facebook page connection requires attention')
      end
  ...
  describe 'whatsapp_disconnect' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq('Your WhatsApp connection requires attention')
    end
  ...
  describe 'instagram_disconnect' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq('Your Instagram connection requires attention')
    end
