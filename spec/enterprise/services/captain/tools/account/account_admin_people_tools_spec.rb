...
RSpec.describe 'Captain account admin people copilot tools' do
  ...
  describe Captain::Tools::Account::CreateUserInviteService do
  ...
  describe Captain::Tools::Account::UpdateUserRoleService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::UpdateUserAvailabilityService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::DeactivateUserService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::ReactivateUserService do
    let(:service) { described_class.new(assistant, user: admin) }
    ...
    it 'restores the saved workspace and protects it from the stale destroy job' do
      ...
      deactivate_payload = JSON.parse(
        Captain::Tools::Account::DeactivateUserService.new(assistant, user: admin).execute(user_id: operator.id)
      )
  ...
  describe Captain::Tools::Account::AssignUserToTeamService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::RemoveUserFromTeamService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::CreateTeamService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::UpdateTeamService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::ArchiveTeamService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe 'permissions and registry exposure' do
    it 'hides write tools from non-admin operators' do
      ...
      expect(Captain::Tools::Account::CreateTeamService.new(assistant, user: agent).active?).to be(false)
      expect(Captain::Tools::Account::UpdateUserRoleService.new(assistant, user: agent).active?).to be(false)
    end

    it 'rejects direct non-admin execution as defense in depth' do
      agent = create(:user, account: account)
      service = Captain::Tools::Account::CreateTeamService.new(assistant, user: agent)
