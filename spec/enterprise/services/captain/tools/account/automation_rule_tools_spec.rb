...
RSpec.describe 'Captain automation rule copilot tools' do
  ...
  describe Captain::Tools::Account::ListAutomationRulesService do
  ...
  describe Captain::Tools::Account::GetAutomationRuleService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::CreateAutomationRuleService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::UpdateAutomationRuleService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::SetAutomationRuleStatusService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::DeleteAutomationRuleService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe 'permissions and registry exposure' do
    it 'hides automation control tools from non-admin operators and rejects direct execution' do
      ...
      service = Captain::Tools::Account::CreateAutomationRuleService.new(assistant, user: agent)
    ...
    it 'does not create confirmation requests for inactive direct tool execution' do
      allow(Captain::Copilot::ToolConfirmationGate).to receive(:new).and_call_original
      agent = create(:user, account: account)
      service = Captain::Tools::Account::CreateAutomationRuleService.new(assistant, user: agent, copilot_thread: copilot_thread)
