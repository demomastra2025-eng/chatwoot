...
RSpec.describe 'Captain knowledge admin copilot tools' do
  ...
  describe Captain::Tools::Account::ListCaptainKnowledgeDocumentsService do
  ...
  describe Captain::Tools::Account::GetCaptainKnowledgeDocumentService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::CreateCaptainKnowledgeDocumentService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::UpdateCaptainKnowledgeDocumentService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::ResyncCaptainKnowledgeDocumentService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::DeleteCaptainKnowledgeDocumentService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe 'knowledge entry tools' do
    ...
    it 'lists and gets entries with redacted body' do
      ...
      list_payload = JSON.parse(Captain::Tools::Account::ListCaptainKnowledgeEntriesService.new(assistant, user: admin).execute(query: 'pay'))
      get_payload = JSON.parse(Captain::Tools::Account::GetCaptainKnowledgeEntryService.new(assistant, user: admin).execute(entry_id: entry.id))
    ...
    it 'allows attaching an entry to a same-account document owned by another assistant' do
      ...
      service = Captain::Tools::Account::CreateCaptainKnowledgeEntryService.new(assistant, user: admin)
      payload = JSON.parse(
        service.execute(
          assistant_id: assistant.id,
          question: 'Shared doc?',
    ...
    it 'allows moving an entry to a same-account document owned by another assistant' do
      ...
      service = Captain::Tools::Account::UpdateCaptainKnowledgeEntryService.new(assistant, user: admin)
      payload = JSON.parse(
        service.execute(
          entry_id: entry.id,
          document_id: other_document.id
    ...
    it 'creates, updates, and deletes manual entries with confirmation-gated services' do
      created_payload = JSON.parse(
        Captain::Tools::Account::CreateCaptainKnowledgeEntryService.new(assistant, user: admin).execute(
          assistant_id: assistant.id,
      ...
      updated_payload = JSON.parse(
        Captain::Tools::Account::UpdateCaptainKnowledgeEntryService.new(assistant, user: admin).execute(
      ...
      deleted_payload = JSON.parse(
        Captain::Tools::Account::DeleteCaptainKnowledgeEntryService.new(assistant, user: admin).execute(entry_id: created_entry.id)
      )
