...
RSpec.describe 'Captain assistant admin copilot tools' do
  ...
  describe Captain::Tools::Account::ListCaptainAssistantsService do
  ...
  describe Captain::Tools::Account::GetCaptainAssistantService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::PreviewCaptainAssistantPromptService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::UpdateCaptainAssistantService do
    let(:service) { described_class.new(assistant, user: admin) }
