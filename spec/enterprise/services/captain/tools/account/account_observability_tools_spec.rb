...
RSpec.describe 'Captain assistant account observability tools' do
  ...
  describe Captain::Tools::Account::GetAccountHealthService do
  ...
  describe Captain::Tools::Account::GetRecentAccountErrorsService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::GetToolExecutionLogService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::TraceAiResponseService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::TraceMessageDeliveryService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::GetChannelHealthService do
    let(:service) { described_class.new(assistant, user: admin) }
