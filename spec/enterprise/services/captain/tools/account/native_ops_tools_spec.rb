...
RSpec.describe 'Captain native ops tools' do
  ...
  describe Captain::Tools::Account::SendMessageToConversationService do
  ...
  describe Captain::Tools::Account::ListChannelTemplatesService do
  ...
  describe Captain::Tools::Account::AssignConversationService do
  ...
  describe Captain::Tools::Account::RetryFailedMessageService do
  ...
  describe Captain::Tools::Account::EditMessageService do
  ...
  describe Captain::Tools::Account::TranslateMessageService do
  ...
  describe Captain::Tools::Account::SearchCannedResponsesService do
  ...
  describe Captain::Tools::Account::CreateCannedResponseService do
  ...
  describe Captain::Tools::Account::MergeContactsService do
  ...
  describe Captain::Tools::Account::GetWhatsappWebDiagnosticsService do
    it 'returns diagnostics for a whatsapp web inbox' do
      ...
      service = described_class.new(assistant, user: user, conversation: conversation)
      allow(service).to receive(:whatsapp_web_inbox!).with(123).and_return(inbox)
  ...
  describe Captain::Tools::Account::ReconnectWhatsappWebService do
    it 'reconnects a whatsapp web inbox' do
      ...
      service = described_class.new(assistant, user: user, conversation: conversation, copilot_thread: copilot_thread)
      allow(service).to receive(:whatsapp_web_inbox!).with(456).and_return(inbox)
  ...
  describe Captain::Tools::Account::CreateLabelService do
    ...
    it 'does not mutate until the backend confirmation gate permits execution' do
      allow(Captain::Tools::ToolConfirmationGate).to receive(:new).and_call_original
      service = described_class.new(assistant, user: user, conversation: conversation, copilot_thread: copilot_thread)
  ...
  describe Captain::Tools::Account::UpdateLabelService do
  ...
  describe Captain::Tools::Account::RemoveLabelFromConversationService do
  ...
  describe Captain::Tools::Account::ListCampaignsService do
    ...
    it 'hides campaign controls from non-admin users' do
      ...
      campaign_tool_classes = [
        described_class,
        Captain::Tools::Account::PreviewCampaignService,
        Captain::Tools::Account::GetCampaignAnalyticsService,
        Captain::Tools::Account::RetryFailedCampaignDeliveriesService
      ]
  ...
  describe Captain::Tools::Account::PreviewCampaignService do
  ...
  describe Captain::Tools::Account::GetCampaignAnalyticsService do
  ...
  describe Captain::Tools::Account::RetryFailedCampaignDeliveriesService do
  ...
  describe Captain::Tools::Account::CreateWebhookService do
  ...
  describe Captain::Tools::Account::UpdateWebhookService do
