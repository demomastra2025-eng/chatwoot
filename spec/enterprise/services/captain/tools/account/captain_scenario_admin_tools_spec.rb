...
RSpec.describe 'Captain scenario admin copilot tools' do
  ...
  describe Captain::Tools::Account::ListCaptainScenariosService do
  ...
  describe Captain::Tools::Account::GetCaptainScenarioService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::CreateCaptainScenarioService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::UpdateCaptainScenarioService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::SetCaptainScenarioStatusService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::DeleteCaptainScenarioService do
    let(:service) { described_class.new(assistant, user: admin) }
