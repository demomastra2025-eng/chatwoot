...
RSpec.describe Captain::Tools::Account::UpdateInboxWorkingHoursService do
  ...
  it 'updates inbox working hours and toggle inside the assistant account' do
    inbox = create(:inbox, account: account, inherit_working_hours_from_account: false, working_hours_enabled: false)
    schedule = [
      {
        day_of_week: 1,
        open_hour: 10,
