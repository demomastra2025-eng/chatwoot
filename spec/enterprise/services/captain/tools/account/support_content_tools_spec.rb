...
RSpec.describe 'Captain support content copilot tools' do
  ...
  describe Captain::Tools::Account::GetCannedResponseService do
  ...
  describe Captain::Tools::Account::UpdateCannedResponseService do
  ...
  describe Captain::Tools::Account::DeleteCannedResponseService do
  ...
  describe Captain::Tools::Account::ListMacrosService do
  ...
  describe Captain::Tools::Account::GetMacroService do
  ...
  describe Captain::Tools::Account::CreateMacroService do
  ...
  describe Captain::Tools::Account::UpdateMacroService do
  ...
  describe Captain::Tools::Account::DeleteMacroService do
