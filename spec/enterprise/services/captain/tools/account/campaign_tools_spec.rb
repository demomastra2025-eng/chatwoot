...
RSpec.describe 'Captain campaign copilot tools' do
  ...
  describe Captain::Tools::Account::GetCampaignService do
  ...
  describe Captain::Tools::Account::CreateCampaignService do
  ...
  describe Captain::Tools::Account::UpdateCampaignService do
  ...
  describe Captain::Tools::Account::DeleteCampaignService do
  ...
  describe Captain::Tools::Account::LaunchCampaignService do
  ...
  describe Captain::Tools::Account::TestSendCampaignService do
  ...
  describe Captain::Tools::Account::CancelCampaignService do
  ...
  describe Captain::Tools::Account::RestartCampaignService do
  ...
  describe Captain::Tools::Account::ResumeCampaignService do
