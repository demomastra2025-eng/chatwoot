...
RSpec.describe 'Captain CRM custom field catalog tools' do
  ...
  it_behaves_like(
    ...
    'deal',
    Captain::Tools::Account::ListDealCustomFieldsService,
  ...
  it_behaves_like(
    'a CRM custom field catalog tool',
    'task',
    Captain::Tools::Account::ListTaskCustomFieldsService,
  ...
  it_behaves_like(
    'a CRM custom field catalog tool',
    'appointment',
    Captain::Tools::Account::ListAppointmentCustomFieldsService,
  ...
  it 'lists task custom fields for the deal_task context when a current deal exists' do
    ...
    copilot_result = JSON.parse(
      Captain::Tools::Account::ListTaskCustomFieldsService.new(assistant, user: user, conversation: conversation).execute
    )
  ...
  it 'lists appointment custom fields for the booking_intake write context' do
    ...
    result = JSON.parse(Captain::Tools::Account::ListAppointmentCustomFieldsService.new(assistant, user: user).execute)
