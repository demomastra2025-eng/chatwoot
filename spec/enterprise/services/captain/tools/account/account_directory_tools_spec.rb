...
RSpec.describe 'Captain account directory copilot tools' do
  ...
  describe Captain::Tools::Account::ListAccountUsersService do
  ...
  describe Captain::Tools::Account::ListTeamsService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::ListInboxesService do
    let(:service) { described_class.new(assistant, user: admin) }
  ...
  describe Captain::Tools::Account::ListAssignmentPoliciesService do
    let(:service) { described_class.new(assistant, user: admin) }
