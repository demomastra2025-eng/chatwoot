...
RSpec.describe Captain::Tools::Copilot::ListDealPipelinesService do
  ...
  it 'returns active account pipelines with ordered stages and deal counts' do
    ...
    inactive_stage = create(:crm_stage, account: account, pipeline: secondary_pipeline, name: 'Inactive', code: 'inactive', active: false, position: 3, color: '#444444')
