Rails.application.routes.draw do
    ...
    namespace :v1 do
      ...
      resources :accounts, only: [:create, :show, :update] do
        ...
        scope module: :accounts do
          ...
          resources :access_roles, only: [:index, :create, :update, :destroy]
  ...
  get 'internal/voice/ai/janus-sip/profiles', to: 'internal/voice/ai/janus_sip_profiles#index'
  ...
  devise_scope :super_admin do
    ...
    namespace :super_admin do
      ...
      resource :app_config, only: [:show, :create] do
        ...
        post :refresh_openrouter_key_health
      end
