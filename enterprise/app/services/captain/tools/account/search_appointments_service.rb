class Captain::Tools::Account::SearchAppointmentsService < Captain::Tools::Account::BaseAccountTool
  def self.name
    'search_appointments'
  end
  ...
  def execute(client_name: nil, status: nil, contact_id: nil, resource_id: nil, from: nil, to: nil, limit: nil)
    ...
    appointments = permissible_appointments.includes(
      :resource,
      :service,
      :company,
      :contact,
