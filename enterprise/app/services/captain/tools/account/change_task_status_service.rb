class Captain::Tools::Account::ChangeTaskStatusService < Captain::Tools::Account::BaseAccountTool
  def self.name
    'change_task_status'
  end
  ...
  def execute(status_id: nil, status_name: nil, status_code: nil)
    ...
    formatted_payload(::Crm::ToolPayloadBuilder.task_payload(action: 'change_task_status', task: task))
