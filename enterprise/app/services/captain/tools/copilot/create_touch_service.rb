class Captain::Tools::Copilot::CreateTouchService < Captain::Tools::Copilot::BaseAccountTool
  ...
  param :relative_anchor, type: :string, desc: 'Optional relative anchor for deal, task, appointment, or conversation', required: false
  ...
  def execute(
    ...
    formatted_payload(::Outbound::PayloadBuilder.touch_payload(touch))
