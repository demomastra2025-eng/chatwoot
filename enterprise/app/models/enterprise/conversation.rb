module Enterprise::Conversation
  ...
  def bot_handoff!(status_reason: nil, actor: Current.user || Current.executed_by, source: 'system', audit: {}, fence: nil, &)
    result = captain_control_service.handoff!(status_reason: status_reason, actor: actor, source: source, audit: audit, fence: fence, &)
