...
// RecordRuntimeAgentPacket records RTP generated by the server-side AI runtime
// and written directly to Meta. Runtime streams do not have a browser agent
// peer, but for media-readiness and termination callbacks they are the
// agent/assistant side of the call.
func (b *Bridge) RecordRuntimeAgentPacket(payloadBytes int) {
	b.recordAgentPacket(payloadBytes)
}
