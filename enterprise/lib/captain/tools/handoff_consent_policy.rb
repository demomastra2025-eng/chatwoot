class Captain::Tools::HandoffConsentPolicy
  ...
  NEGATED_EMERGENCY_PATTERN = /
    ...
    не\s+сильн[[:alpha:]]*\s+(?:боль[[:alpha:]]*\s+в\s+груди|кровотеч[[:alpha:]]*)|
    нет\s+сильн[[:alpha:]]*\s+(?:боль[[:alpha:]]*\s+в\s+груди|кровотеч[[:alpha:]]*)|
    сильн[[:alpha:]]*\s+(?:боль[[:alpha:]]*\s+в\s+груди|кровотеч[[:alpha:]]*)\s+нет
  /ix
  ...
  EMERGENCY_PATTERN = /
    ...
    сильн[[:alpha:]]*\s+боль[[:alpha:]]*\s+в\s+груди|сильн[[:alpha:]]*\s+кровотеч|
    задыхаюсь|хочу\s+покончить\s+с\s+собой|пытаюсь\s+убить\s+себя|умираю|
