    ...
    def definitions
      @definitions ||= [
        ...
        definition(
          ...
          description: 'List, create, update, or cancel explicitly customer-visible tasks for the current contact and communication thread',
          group_name: 'CRM Tasks',
          icon: 'checklist',
          allowed_scopes: [Captain::ToolAccess::SCOPE_AGENT],
          agent_tool_class: Captain::Tools::CustomerTasksTool,
          required_features: %w[crm_tasks],
          risk_level: 'high',
          idempotent: true
        ),
        ...
        definition(
          ...
          icon: 'list-checks',
          allowed_scopes: [Captain::ToolAccess::SCOPE_ASSISTANT],
          assistant_tool_class: Captain::Tools::Account::ListAutomationRulesService,
          risk_level: 'low',
          idempotent: true
        ),
        definition(
          ...
          icon: 'workflow',
          allowed_scopes: [Captain::ToolAccess::SCOPE_ASSISTANT],
          assistant_tool_class: Captain::Tools::Account::GetAutomationRuleService,
          risk_level: 'low',
          idempotent: true
        ),
        definition(
          ...
          icon: 'plus-circle',
          allowed_scopes: [Captain::ToolAccess::SCOPE_ASSISTANT],
          assistant_tool_class: Captain::Tools::Account::CreateAutomationRuleService,
          risk_level: 'high',
          requires_confirmation: true,
          selected_by_default: false
        ),
        definition(
          ...
          icon: 'edit',
          allowed_scopes: [Captain::ToolAccess::SCOPE_ASSISTANT],
          assistant_tool_class: Captain::Tools::Account::UpdateAutomationRuleService,
          risk_level: 'high',
          requires_confirmation: true,
          selected_by_default: false
        ),
        definition(
          ...
          icon: 'power',
          allowed_scopes: [Captain::ToolAccess::SCOPE_ASSISTANT],
          assistant_tool_class: Captain::Tools::Account::SetAutomationRuleStatusService,
          risk_level: 'high',
          requires_confirmation: true,
          selected_by_default: false
        ),
        definition(
          ...
          icon: 'trash',
          allowed_scopes: [Captain::ToolAccess::SCOPE_ASSISTANT],
          assistant_tool_class: Captain::Tools::Account::DeleteAutomationRuleService,
          risk_level: 'high',
          requires_confirmation: true,
          selected_by_default: false
        ),
