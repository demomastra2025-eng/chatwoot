module Redis::RedisKeys
  ...
  CAPTAIN_RESPONSE_CANCELLATION_STATE = 'CAPTAIN_RESPONSE_CANCELLATION_STATE::%<conversation_id>d'.freeze
  ...
  WHATSAPP_WEB_LIFECYCLE_MUTEX = 'WHATSAPP_WEB_LIFECYCLE_LOCK::%<channel_id>s'.freeze
