      ...
      feature_model_names = feature_config_models_for(feature_key, account: account)
      {
        models: feature_model_names.filter_map do |model_name|
...

          {
            ...
            supported_embedding_dimensions: model['supported_embedding_dimensions'],
            supports_embedding_dimension_override: model['supports_embedding_dimension_override'],
            supports_embedding_input_type: model['supports_embedding_input_type'],
